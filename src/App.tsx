            ...
            element={
              <main>
                ...
                <div id="about-us">
                  <Section
                    title="About Us"
                    text="IPage Vision is an elite architectural visualization studio, based in Singapore and servicing clients worldwide. We specialize in high-end 3D renderings and immersive digital experiences. Our team of architectural designers, 3D artists, and visual storytellers are dedicated to bringing architectural concepts to life. We work closely with architects, developers, and designers, turning their ideas into stunning visual narratives that captivate and inspire. Our passion for detail and innovation ensures that each project is a true reflection of our client's vision."
                  />
                </div>
                <div id="our-team">
                  <Section
